...
class BaseDao {
     ...
     * @returns {Promise}
     */
    findAll(condition, constraints = {_id: 0}) {
        return new Promise((resolve, reject) => {
     ...
     * @returns {Promise}
     */
    findOne(condition, constraints = {_id: 0}) {
        return new Promise((resolve, reject) => {
    ...
    findOneAndRemove(condition) {
        return new Promise((resolve, reject) => {
            this.Model.findOneAndDelete(condition, (error, result) => {
                if (error) {
                    console.log('findOneAndRemove error --> ', error)
                    reject(error)
                } else {
    ...
    findOneAndModify(condition, updater) {
        return new Promise((resolve, reject) => {
            this.Model.findOneAndUpdate(condition, updater, (error, result) => {
                if (error) {
